...
namespace RadSystems
{
    public partial class Form1 : Form
    {
        ...
        private string connectionString = "Host=127.0.0.1;Username=postgres;Password=123;Database=TurAgency";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            modal_window = new Form2(button1.Text, tabControl1.SelectedTab, dataGridViews[tabControl1.SelectedIndex]);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            modal_window = new Form2(button2.Text, tabControl1.SelectedTab, dataGridViews[tabControl1.SelectedIndex]);
            modal_window.ShowDialog();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            modal_window = new Form2(button3.Text, tabControl1.SelectedTab, dataGridViews[tabControl1.SelectedIndex]);
            modal_window.ShowDialog();
